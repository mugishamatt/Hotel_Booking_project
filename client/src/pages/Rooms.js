...
// const[type , settype]=useState('all')
    ...
    function filterByCategory(e){
      const filteredCategories = roomsData.filter((room) =>
      room.category.toLowerCase()===(e.toLowerCase())
    ...
    {/* filter by ctagory */}
    <div>
  <select className=" col-md-4" aria-label="Default select example" value={category} onChange={(e)=>{filterByCategory(e.target.value)}}>
  ...
  <option value="double">double</option>
   ...
   <div className="col-md-5 justify-content-center" >
      ...
      <div className="row clearfix">
        ...
        {/* searched by key */}
        {duplicate.length > 0 ? <FilteredRooms filteredRooms={duplicate} handleBookRoom={handleBookRoom} roomDetails={roomDetails}/>
              ...
              <div className="card product_item">
                  <div className="body">
                      ...
                      <div key={room._id}  className="product_details">
                          <h5><a href="ec-product-detail.html">{room.name}</a></h5>
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      <div className="modal-header">
        <h1 className="modal-title fs-5" id="exampleModalLabel">{roomdetails.name}</h1>
      

        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div className="cp_img">
  {roomdetails.imagesUrl && <img src={roomdetails.imagesUrl[0]} alt="Product" className="img-fluid"/>}
</div>
