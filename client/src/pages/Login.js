...
const navigate=useNavigate()
  ...
  const handleLoginBtn= async (e)=>{
    e.preventDefault();
     ...
     try {
       const res= await axios.post('http://localhost:4000/users/login',userInput)
  ...
  <div className="jumbotron" style={{height:'auto', minHeight: '300px'} }>
{/*   
    ...
    <div className="col-md-6 form-content">
        <form className="form-horizontal" role="form" onSubmit={handleLoginBtn}>
            <div className="form-group text-center">
              ...
              <div className="form-group">
                <div className="col-sm-10">
                  <input type="email" className="form-control" id="Username" placeholder="Username" name="email" value={userInput.email} onChange={handleOnChange}  />
                </div>
              </div>
              <div className="form-group">
                <div className="col-sm-10">
                  <input type="password" className="form-control" id="inputPassword3" placeholder="Password" name="password" value={userInput.password}onChange={handleOnChange} />
                </div>
              </div>
              <div className="form-group">
                <div className="col-sm-10">
